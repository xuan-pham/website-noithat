...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('server') }}/newAdd/styleServer.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('server') }}/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-blue">@yield('title')</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
    ...
    <script src="{{ asset('server') }}/newAdd/jsServer.js"></script>
    @yield('js')
</body>
