                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <ul>
                                @foreach ($categoryBlog as $item)
                                    <li><a href="{{ route('danh-muc-tin-tuc',$item->id) }}">{{ $item->name }} <span  style="color: brown">({{ $item->countBlog->count() }})</span></a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="blog__item">
                                    ...
                                    <div class="blog__item__text">
                                        ...
                                        <h5><a href="{{ route('chi-tiet-tin-tuc', $item->id) }}">{{ $item->name }}</a>
                                        </h5>
                                        <p class="box-ps">{{ $item->content }}</p>
                                        <a href="{{ route('chi-tiet-tin-tuc', $item->id) }}" class="blog__btn">ĐỌC
